...
export const metadata: Metadata = {
  ...
  description:
    "West Adelaide Legal Pty Ltd privacy policy and information about how personal information is managed.",
...
export default function PrivacyPolicyPage() {
  return (
    <>
      <PageHero
        title="Privacy Policy"
        description="Our ongoing obligations in respect of how we manage your Personal Information."
      />
      <article className="privacy-content site-container">
        <p>
          West Adelaide Legal Pty Ltd is committed to providing quality services to you and this
        ...
        <p>
          ...
          1988 (Cth) (the Privacy Act). The NPPs govern the way in which we collect, use, disclose,
        ...
        <section>
          ...
          <p>
            ...
            www.westadelaidelegal.com.au, from other publicly available sources, from cookies and
            from third parties. We don&apos;t guarantee website links or policy of authorised third
            parties.
          </p>
          <p>
          ...
          <p>
            When we collect Personal Information we will, where appropriate and where possible,
        ...
        <section>
          ...
          <p>
            West Adelaide Legal Pty Ltd will not charge any fee for your access request, but may
            charge an administrative fee for providing a physical copy of your Personal Information.
          </p>
          <p>
        ...
        <section>
          ...
          <ul>
            ...
            <li>{siteConfig.addressPlain}</li>
            <li><a href={siteConfig.phoneHref}>{siteConfig.phoneInternational}</a></li>
          </ul>
        </section>
      </article>
    </>
